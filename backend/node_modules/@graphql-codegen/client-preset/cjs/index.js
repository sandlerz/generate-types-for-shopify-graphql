...
exports.preset = {
    ...
    buildGeneratesSection: options => {
        ...
        const isPersistedOperations = (_b = !!((_a = options.presetConfig) === null || _a === void 0 ? void 0 : _a.persistedDocuments)) !== null && _b !== void 0 ? _b : false;
        const reexports = [];
        ...
        if (typeof ((_c = options === null || options === void 0 ? void 0 : options.presetConfig) === null || _c === void 0 ? void 0 : _c.fragmentMasking) === 'object') {
            fragmentMaskingConfig = options.presetConfig.fragmentMasking;
        }
        else if (((_d = options === null || options === void 0 ? void 0 : options.presetConfig) === null || _d === void 0 ? void 0 : _d.fragmentMasking) !== false) {
            // `true` by default
            fragmentMaskingConfig = {};
        }
        const onExecutableDocumentNodeHook = (_e = options.presetConfig.onExecutableDocumentNode) !== null && _e !== void 0 ? _e : null;
        ...
        function onExecutableDocumentNode(documentNode) {
            const meta = onExecutableDocumentNodeHook === null || onExecutableDocumentNodeHook === void 0 ? void 0 : onExecutableDocumentNodeHook(documentNode);
            if (persistedDocuments) {
                const documentString = (0, persisted_documents_js_1.normalizeAndPrintDocumentNode)(documentNode);
                const hash = (0, persisted_documents_js_1.generateDocumentHash)(documentString);
        ...
        const plugins = [
            ...
            { [`typescript-operations`]: {} },
            {
                [`typed-document-node`]: {
                    ...
                    unstable_omitDefinitions: (_f = persistedDocuments === null || persistedDocuments === void 0 ? void 0 : persistedDocuments.omitDefinitions) !== null && _f !== void 0 ? _f : false,
                },
            },
            ...options.plugins,
        ];
